...
sub main
	...
	'enlaceArchivo = Replace(sFileName2, " ", "%20")
        items = items & "<tr>"
	    items = items & "<td>"& xRs("Comprobante").Value & "</td>"
	    'items = items & "<td><a href=""" & "file://" & enlaceArchivo & """>" & nameFile & "</a></td>"
    ...
    xBody    = "Recuerde controlar sus facturas vencidas. Si ya realizaron el pago de las mismas, deben enviar el comprobante de pago y retenciones a la casilla del correo para imputar el pago"
