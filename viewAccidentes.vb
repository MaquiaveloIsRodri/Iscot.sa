...
sub main
	...
	do while not xRs.EOF
		if cc <> xRs("CENTROCOSTOS").Value then
			if Cc <> "" Then
				...
				HojaExcel.ActiveSheet.Cells(I, 7).Value 		= cc
				I = I + 1
			end if
			cc = xRs("CENTROCOSTOS").Value
			MontoActual = 0.0
	...
	HojaExcel.ActiveSheet.Cells(I + 1, 1).Font.Bold 				= true 	' Negrita.
	HojaExcel.ActiveSheet.Cells(I + 1, 1).Interior.ColorIndex 		= 43 	' Fondo.
