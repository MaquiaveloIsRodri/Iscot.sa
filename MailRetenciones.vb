...
sub main
	...
	email_cuerpo		= "Estimados," & vbNewLine _
						& "A traves de este medio, se adjuntan los Certificados de las Retenciones aplicadas." & vbNewLine _
						& "Les rogamos que nos comuniquen de inmediato ante cualquier error." & vbNewLine & vbNewLine _
						& "CONFIRMAR RECEPCION." & vbNewLine & vbNewLine _
	...
	if email_para = "" then
		MsgBox "No indica los destinatarios, campo 'Para:'.", 48, "Aviso"
		exit sub
	end if
	...
	if rpt_arba then
		...
		if pdf_listo then
			...
			SendDebug " >>> Falla el PDF RET IIBB ARBA PAGO: " & Self.NumeroDocumento
		end if
	end if
