...
'    End If
    ...
    ExisteBO (Self, "TRSOLICITUD","TIPOTRANSACCION_ID","D047C5C7-71D0-47AC-865F-C3222EB46F52",nil,true,false,"=")
    ...
    Do While Not query.eof
        ...
        'Bandera = True
			...
			set xFSO 		= CreateObject("Scripting.FileSystemObject")
    		set xArchivo    = xFSO.OpenTextFile("C:\util\html\email-recepcion.html")
            htmlBody = xArchivo.readAll()

			xName = xNombre + " " + xApellido
			htmlBody = replace(htmlBody,"xEPotencial" , xName)

    		xSubject = "[Gracias por postularte!] "
    		xBody    = ""
    		xcorreos = "rodrigofierrro@gmail.com;rodrigocasomolina@iscot.com.ar"
    		xadjunto = ""
			xRemitente  = "cv@iscot.com.ar;"
			call Enviar_aviso_remitente(Self, xcorreos, xSubject, xBody, xadjunto,htmlBody,xRemitente)
